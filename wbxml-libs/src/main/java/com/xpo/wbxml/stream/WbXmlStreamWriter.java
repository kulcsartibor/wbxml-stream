 ...
 * 
 */
package com.xpo.wbxml.stream;

import com.xpo.wbxml.utils.XMLChar;
...
import com.xpo.wbxml.document.WbXmlAttribute;
import com.xpo.wbxml.document.WbXmlBody;
import com.xpo.wbxml.document.WbXmlContent;
import com.xpo.wbxml.document.WbXmlDocument;
import com.xpo.wbxml.document.WbXmlElement;
...
public class WbXmlStreamWriter implements XMLStreamWriter {
     ...
     */
    private final Deque<ElementContext> parents;
     ...
     */
    private final WbXmlEncoder.StrtblType encoderType;
     ...
     */
    private final WbXmlVersion version;
