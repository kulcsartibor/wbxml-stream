 ...
 * <h3>SYNOPSYS</h3>
 * 
 * <p>java -cp wbxml-jaxb-X.X.X.jar com.xpo.wbxml.tools.Xml2WbXml
 ...
 * 
 * <pre>
 * java -cp wbxml-stream-0.1.0.jar com.xpo.wbxml.tools.WbXml2Xml si.wbxml -
 *     Convert the file si.wbxml into XML and the result is displayed in the
 *     standard output.
 * 
 * java -cp wbxml-stream-0.1.0.jar com.xpo.wbxml.tools.WbXml2Xml si.wbxml si.xml
 *     Convert the file si.wbxml into XML and the result is placed in si.xml
 * 
 * java -cp wbxml-stream-0.1.0.jar com.xpo.wbxml.tools.WbXml2Xml -d "SI 1.0" si.wbxml -
