 ...
 * <h3>SYNOPSYS</h3>
 * 
 * <p>java -cp wbxml-jaxb-X.X.X.jar com.xpo.wbxml.tools.WbXml2Xml
 ...
 * 
 * <pre>
 * java -cp wbxml-stream-0.1.0.jar com.xpo.wbxml.tools.Xml2WbXml si.xml si.wbxml
 *     Convert the file si.xml into WBXML and the result is placed in si.wbxml
 * 
 * java -cp wbxml-stream-0.1.0.jar com.xpo.wbxml.tools.Xml2WbXml -d "SI 1.0" si.xml si.wbxml
